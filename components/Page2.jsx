...
export default function () {
  return (
    <div className='cust-class2 w-full'>
        <div className="header text-center justify-center align-middle items-center mt-28 text-[#EF4136]">
        <Image
        src={avatar}
        width={100}
        height={100}
      ...
      <form action="#" method="post" className="info-form max-w-full my-5 px-8">
        <div className='flex flex-col w-full text-[#EF4136] text-[10px]'>
            <div className='flex flex-row w-full'>
                <div className='flex flex-col w-[50%]'>
                    ...
                    <div className="flex flex-row">
                        ...
                        <input className='w-[40%] bg-transparent ml-2 text-[#EF4136]' type="text" id="dob" name="dob" required/>
                    </div>
                    <div className="flex flex-row">
