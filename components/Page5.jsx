...
export default function () {
  return (
    <div className='cust-class5 w-full'>
        <div className="header text-center justify-center align-middle items-center mt-16 text-[#F4E5AE]">
      ...
      <form action="#" method="post" className="info-form max-w-full my-5 px-8">
        <div className='flex flex-col w-full text-[#F4E5AE] text-[10px]'>
            <div className='flex flex-row w-full'>
                <div className='flex flex-col w-[50%]'>
                    ...
                    <div className="flex flex-row">
                        ...
                        <input className='w-[40%] bg-transparent ml-2 text-[#F4E5AE]' type="text" id="dob" name="dob" required/>
                    </div>
                    <div className="flex flex-row">
