...
export default function () {
  return (
    <div className='cust-class7 w-full'>
        <div className="header text-center justify-center align-middle items-center mt-16 text-[#536875]">
      ...
      <form action="#" method="post" className="info-form max-w-full my-5 px-8">
        <div className='flex flex-col w-full text-[#536875] text-[10px]'>
            <div className='flex flex-row w-full'>
                <div className='flex flex-col w-[50%]'>
                    ...
                    <div className="flex flex-row">
                        ...
                        <input className='w-[40%] bg-transparent ml-2 text-[#536875]' type="text" id="dob" name="dob" required/>
                    </div>
                    <div className="flex flex-row">
