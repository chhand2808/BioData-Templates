...
export default function () {
  return (
    <div className='cust-class13 w-full'>
        <div className="header text-center justify-center align-middle items-center mt-10 text-[#D09D4A]">
      ...
      <form action="#" method="post" className="info-form max-w-full my-5 px-8">
        <div className='flex flex-col w-full text-[#D09D4A] text-[10px]'>
            <div className='flex flex-row w-full'>
                <div className='flex flex-col w-[50%]'>
                    ...
                    <div className="flex flex-row">
                        ...
                        <input className='w-[40%] bg-transparent ml-2 text-[#D09D4A]' type="text" id="dob" name="dob" required/>
                    </div>
                    <div className="flex flex-row">
